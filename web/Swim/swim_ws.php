...
if(isset($_GET['swim_user']) && intval($_GET['swim_user'])) {
  ...
  $db_password='Pr2y3r$';
    ...
    /* connect to the db */
    $link = mysql_connect('localhost',$db_name, $db_password) or die('Cannot connect to the DB');
    mysql_select_db('swim_user',$link) or die('Cannot select the DB');
