...
import com.wilmss.android.PrayerRequestJournal.repository.*;
import com.wilmss.android.PrayerRequestJournal.domain.*;
...
public class PrayerRequestRepositorySqlLite {
	...
	public List<PrayerRequest> getAllRequests(){
		...
		Cursor cursor = database.query(PrayerRequestSqlLiteHelper.TABLE_PRAYER_REQUEST, allColumns, null, 
				null, null, null, null);
